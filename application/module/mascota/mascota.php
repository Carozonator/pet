...
<div class="main-content_container" style="padding:30px">
    <div style="margin-bottom: 30px;position:relative;">
        ...
        <a href="http://www.facebook.com/sharer.php?u=/<?php echo $_SERVER['SERVER_NAME'].'/'.$controller.'/'.$mascota['id'];?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;">
