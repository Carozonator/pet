...
<footer>
    ...
    <div class="f_navigation" style="position:relative;">
        <div class="container_12" >
                ...
                <nav class="f_menu">
                    ...
                    <div class="menu-information-container">
                        <ul id="menu-information" class="menu">
                            ...
                            <li id="menu-item-46" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-46"><a href="/informacion/politicas-de-privacidad/">Políticas de Privacidad</a></li>
                        </ul>
                    </div>                
                </nav>
            </div>
            ...
            <div class="grid_3 facebook_footer">
...
<div id="popup_registracion" class="overlay_box">
    ...
    <div style="position:absolute;bottom:0px;left:0px;width:60%;height:40px;cursor:pointer" onclick="window.location='/informacion/terminos-y-condiciones/'"></div>
    <div style="position:absolute;bottom:0px;right:0px;width:30%;height:40px;cursor:pointer" onclick="closeOverlay();"></div>
    <div style="position:absolute;top:53%;left:330px;width:10%;height:30px;cursor:pointer;" onclick="$('#popup_registracion').hide();Register.open();"></div>
</div>
