...
$to      =  $user->email;
$subject = 'Confirma Registracion';
$message = '<html>'
        . '<body>'
        . '<img style="width:200px;height:auto" src="'.DOMAIN.'/media/logo.png"/>'
        . '<p>Hola '.$user->firstname.',</p>'
        . '<p>Confirmando tu cuenta, accedes a todas las funcionalidades de PluralPet</p>'
        ...
        . 'href="'.DOMAIN.'/registracion/'.$user->id.'">Confirma tu cuenta</a>'
        . '<p>Saludos</p>'
